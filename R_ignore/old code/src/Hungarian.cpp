...
//------------------------------------------------
// carry out Hungarian algorithm to find best matching given cost matrix M. If no best matching found then return vector with first element -1 to indicate error.
