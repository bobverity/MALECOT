...
#saveRDS(myproj, file = "../inst/extdata/tutorial4_myproj.rds")
```

```{r}
# load results
myproj <- malecot_file("tutorial4_myproj.rds")
get_ESS(myproj, K = 3)
```
...
# load results
myproj <- malecot_file("tutorial4_myproj2.rds")
...
```{r, echo=FALSE}
# secretly save/load data from file so results are consistent
#saveRDS(myproj, file = "../inst/extdata/tutorial4_myproj2.rds")
```
