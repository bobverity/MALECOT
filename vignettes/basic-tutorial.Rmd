...
```{r}
plot(myproj$output$single_set$set2$single_K$K3$raw$e1)
plot(myproj$output$single_set$set2$single_K$K3$raw$e2)
plot_e_quantiles(myproj)

plot(myproj$output$single_set$set2$single_K$K3$raw$COI_mean[,1])
plot(myproj$output$single_set$set2$single_K$K3$raw$COI_mean[,2])
plot(myproj$output$single_set$set2$single_K$K3$raw$COI_mean[,3])
